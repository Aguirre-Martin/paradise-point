        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Cocina Completamente Equipada</h3>
              <p className="text-gray-600">Horno, heladera, vajilla</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Piscina de 10 x 4</h3>
              <p className="text-gray-600">Playadito y pileta enorme</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Estacionamiento Privado</h3>
              <p className="text-gray-600">Espacio seguro para tu vehículo</p>
            </div>

            <div className="text-center">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-blue-600" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M16.5 3c-1.79 0-3.36.91-4.29 2.3-.93-1.39-2.5-2.3-4.29-2.3C5.48 3 3.5 4.98 3.5 7.42c0 2.07 1.19 3.97 3.11 5.31C7.9 13.66 9.27 14.56 11 15.5v5.5c0 .55.45 1 1 1s1-.45 1-1v-5.5c1.73-.94 3.1-1.84 4.39-2.77 1.92-1.34 3.11-3.24 3.11-5.31C20.5 4.98 18.52 3 16.5 3z"/>
                </svg>
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Espacio al Aire Libre</h3>
              <p className="text-gray-600">Jardín y parque amplios</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Wi-Fi de Alta Velocidad</h3>
              <p className="text-gray-600">Conexión rápida y estable</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Todos los Servicios</h3>
              <p className="text-gray-600">Agua, luz y gas natural</p>
            </div>
          </div>
