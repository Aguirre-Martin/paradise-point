      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 mt-2">{metrics.ocupacionMes}%</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-xs text-gray-500 mt-4">{metrics.totalReservasMes} reservas</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 mt-2">{metrics.diasDisponibles}</p>
              </div>
                ...
                {metrics.proximasReservas.slice(0, 5).map((reserva) => (
                  <div key={reserva.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <p className="font-semibold text-gray-900">{formatCurrency(reserva.totalAmount)}</p>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <p className="text-sm text-gray-600 mt-1">Gestionar disponibilidad</p>
          </a>
