...
export const SITE_CONFIG = {
  ...
  // Para agregar: subir a public/images/comodidades/ y agregar la ruta al array. Array vacío = no se muestra.
  amenitiesImages: {
    exterior: ['/images/pile-casa.jpg', '/images/luces.jpg'],
    cocina: ['/images/comodidades/cocina.jpg'],
    habitacion: ['/images/comodidades/habitacion.jpg'],
    living: ['/images/detalles.jpg'],
    bano: [],
    piscina: [],
    parrillero: [],
    fogonero: [],
